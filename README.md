...
![EEG Band Discovery](/assets/MKS_Website.jpg)

## Personal Heat Transfer Project:
During my senior year of college, I began exploring the idea of incorporating the technology used in climate-controlled (cooled) seats in a car to other types of seats, such as desk chairs and barbershop chairs. To better understand the cooling technology of thermoelectric (TE) devices, I created time-temperature graphs at varying wind speeds and heat sinks. I numerically analyzed the TP devices using principles of heat transfer, such as equations for the convective heat dissipation.
![EEG Band Discovery](/assets/TE_Testing.jpg)
## Arduino
#### 
