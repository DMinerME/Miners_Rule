...
## Desktop Application in Python, MKS Instruments: 
...
During my senior year of college, I began exploring the idea of incorporating the technology used in climate-controlled (cooled) seats in a car to other types of seats, such as desk chairs and barbershop chairs. To better understand the technology, I spent a lot of time analyzing thermoelectric (TE) devices. I attached different heat sinks to the TEs and created time-temperature graphs at varying wind speeds. I numerically analyzed the TP devices using principles of heat transfer, such as equations for the convective heat dissipation of heat sinks.
